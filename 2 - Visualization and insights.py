...
Sentiment_df = pd.DataFrame(twt['Sentiment'].value_counts().reset_index())
...
fig1 = Sentiment_df.iplot(
    ...
    world_readable=True,
    asFigure=True  # Correct spelling here
)
j = ply.offline.plot(fig1,filename="Sentiment")
print(j)